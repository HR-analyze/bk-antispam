...
PROFANITY_ROOTS = (
    ...
    "шлюх", "сук", "суч", "говн", "дерьм", "пидор", "пидар",
    "пидарас", "пидорас", "педик",
)
...
SPAM_PHRASES = (
    ...
    "нужны парни", "нужны девушки", "нужны девочки", "нужны мальчики",
    "требуются парни", "требуются девушки", "требуются девочки", "требуются мальчики",
    "ищем сотрудников", "набираем сотрудников", "требуется персонал", "вакансия", "вакансии",
    "работа для", "ставки на спорт", "букмекер", "казино", "бонус за регистрацию",
    "регистрируйся", "зарегистрируйся", "забери приз", "вы выиграли", "вы выиграли приз",
    "криптовалюта", "инвестиции с гарантией", "гарантированный доход",
    "интимные услуги", "интим за деньги", "секс за деньги", "секс услуги", "эскорт",
    "онлифанс", "onlyfans",
)
...
def looks_like_spam(text):
    ...
    dating = re.search(
        r"\b(знакомств\w*|познаком\w*|девуш\w*|парн\w*|мужчин\w*|женщин\w*|девочк\w*|мальчик\w*|эскорт\w*|интим\w*)\b",
        normalized,
    )
