...
JOB_PHRASES = {"подработка", "подработку", "подработке", "подработки", "подработать", "шабашка", "шабашку", "шабашке", "шабашки", "хорошая подработка", "хорошо оплачиваемая подработка", "хорошо оплачиваемую подработку", "оплачиваемая подработка", "оплачиваемую подработку", "ищу кандидатов", "ищем кандидатов", "нужны кандидаты", "ищу сотрудников", "нужны сотрудники", "требуются сотрудники", "требуются люди", "нужны люди", "нужны мужчины", "нужны мужчина", "нужны женщины", "нужны женщина", "мужчины и женщины", "мужчины или женщины", "мужчины женщины", "парни и девушки", "парни или девушки", "парни девушки", "нужны парни", "нужны девушки", "нужен парень", "нужна девушка", "нужны девочки", "нужна девочка", "ищу девочку", "ищу девочек", "требуется девочка", "требуются девочки", "ищу девушек", "требуется девушка", "требуются девушки", "мужчины на работу", "женщины на работу", "мужчина на работу", "женщина на работу", "ребята на работу", "ребята для работы", "молодые люди на работу", "открыла магазин", "открыл магазин", "открыли магазин", "открываем магазин", "открыла точку", "открыл точку", "открыли точку", "новая схема", "новой схемы", "есть варианты", "есть вариант", "варианты работы", "вариант работы", "новая работа", "новые вакансии", "новая вакансия", "есть вакансия", "есть вакансии", "срочно нужны", "срочно требуются", "нужны на сегодня", "нужны на завтра", "работа на пару часов", "работы на пару часов", "работа на несколько часов", "на несколько часов", "на пару часов", "предоплата", "предоплата имеется", "предоплата есть", "оплата сразу", "выплата сразу", "деньги сразу", "легкий заработок", "лёгкий заработок", "легкие деньги", "лёгкие деньги", "заработок без опыта", "без опыта", "пишите в личку", "пишите в лс", "пишите мне", "кому интересно пишите"}
JOB_SIGNALS = ("подработ", "шабаш", "кандидат", "сотрудник", "ваканс", "предоплат", "оплата", "выплата", "заработ", "схем", "магазин", "точк", "пару часов", "несколько часов", "мужчин", "женщин", "парни", "девушки", "девушка", "девочк", "парень", "ребят", "пишите", "в личку", "в лс")
...
TASK_REQUEST_PHRASES = {"кто сможет помочь", "кто-нибудь сможет помочь", "кто нибудь сможет помочь", "кто может помочь", "кто-нибудь может помочь", "кто нибудь может помочь", "кто может помочь с", "кто-нибудь может помочь с", "кто нибудь может помочь с", "кто сможет помочь с", "кто-нибудь сможет помочь с", "кто нибудь сможет помочь с", "кто-нибудь знает, кто может помочь", "кто нибудь знает кто может помочь", "кто-нибудь знает кто может помочь", "кто нибудь знает, кто может помочь", "кто знает кто может помочь", "кто знает, кто может помочь", "кто знает кто сможет помочь", "кто знает, кто сможет помочь", "есть кто сможет помочь", "есть кто может помочь", "есть кто поможет", "нужен человек помочь", "нужна помощь с", "ищу человека для помощи", "ищу человека помочь", "ищу кто поможет", "нужен кто поможет", "кто поможет с переездом", "кто может помочь с переездом", "кто сможет помочь с переездом", "кто поможет перевезти", "кто может перевезти", "кто сможет перевезти"}
...
def classify(text: str):
    ...
    raw = raw_spaced(text)
    if _matches_any(normalized, PROFANITY_PATTERNS): return "мат"
    if any(phrase in spaced for phrase in NEGATIVE_PHRASES): return "негатив"
    if _matches_any(normalized, SPAM_PATTERNS): return "спам"
    compact = compact_spaced(spaced)
    if any(re.search(pattern, compact, re.I | re.U) for pattern in OBFUSCATED_JOB_PATTERNS): return "подработка"
    if any(normalize_spaced(phrase) in spaced for phrase in JOB_PHRASES): return "подработка"
    job_signal_count = sum(1 for signal in JOB_SIGNALS if normalize_spaced(signal) in spaced)
    if job_signal_count >= 2: return "подработка"
    if _is_fake_purchase_spam(normalized, spaced): return "фейковая покупка"
    if _is_task_request_spam(normalized, spaced): return "платная помощь"
    if _is_paid_task_spam(normalized, spaced, raw): return "платная помощь"
    return None
