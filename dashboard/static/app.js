...
const CLASS_LABELS = {
  ...
  flood: "флуд/повтор",
  // Записи за период, когда классификатор писал в БД русские метки вместо
  // ключей. Оставлено, чтобы старые строки не выглядели отдельными категориями.
  "мат": "мат",
  "негатив": "негатив",
  "спам": "спам/реклама",
  "подработка": "работа/подработка",
  "фейковая покупка": "фиктивная покупка",
  "платная помощь": "платная просьба",
};
